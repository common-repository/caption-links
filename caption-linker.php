...
class caption_linker {
    ...
    {
        wp_enqueue_script( 'caption_linker', plugins_url( 'caption-linker.js', __FILE__ ), array('jquery'), '1.3' );
        wp_enqueue_style( 'caption_linker', plugins_url( 'caption-linker.css', __FILE__ ), array(), '1.3' );
    }
}
